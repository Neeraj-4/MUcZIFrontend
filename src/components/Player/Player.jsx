...
const Player = ({ currentIndex, isMobile, setCurrentIndex, songList, handleDownload }) => {
                        ...
                        <Container>
                            <Wrap>
                                <ImageWrapper>
                                    ...
                                    <TextWrap>
                                        <Song variant='p'>{song.title}</Song>
                                        <Artist variant='p'>{song.artist}</Artist>
                                    </TextWrap>
                                </ImageWrapper>
                                <ActionButton>
                                    <Button>
